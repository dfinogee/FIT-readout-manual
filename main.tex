...
\section{Документация модуля 'FIT readout unit'}
Данная документация документирует работу модуля 'readout unit' детектора FIT. Документация описывает функциональность модуля и основные принципы его работы. Содержит описание функциональных элементов и регистров для управления. Топологическая схема документирования документации представлена на рис ~\ref{fig:1}

\begin{figure}[htbp]
	\centering 
	\includegraphics[width=0.5\textwidth]{scale_2400.jpg}
	\caption{\label{fig:1} Топологическая схема документирования документации}
\end{figure}

Данный раздел является документацией к документации для решения спорных вопросов относительно документации.
